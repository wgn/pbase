package com.zhuani21.pbase.util;
...
public class BaseInitListener implements ServletContextListener {

	private Log log = LogFactory.getLog(BaseInitListener.class);
